	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			case "patient": {
				...
				if (patient == null) {
					// invalid login --> forward the client to login form , highlighted with err
					// mesg
					...
					/*
					 * WC -> sends temp redirect resp (clrs resp buffer) * SC 302 , Headers -
					 * Location - patient_dashboard - Set-Cookie - JSESSIONID : ASDSFDFG13485748SDF
					 * Body - empty
					 */
			...
			case "doctor":{
				...
				System.out.println(doc_email+doc_password);
				Doctor doctor  = doctorDao.signUp();
