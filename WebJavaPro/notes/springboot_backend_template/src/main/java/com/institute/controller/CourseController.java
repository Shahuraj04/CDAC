...
public class CourseController {
	...
	public ResponseEntity<?> updateCourseDetails(@PathVariable Long courseId,@RequestBody @Valid CourseUpdateDto courseUpdateDto){
	...
	public ResponseEntity<?> getAllByCategory(@RequestParam String category) {
	    ...
	    try {
	        ...
	        return ResponseEntity.badRequest()
	                .body("Invalid category. Available categories: JAVA, DBT, ...");
	    }
	...
	public ResponseEntity<?> getAllbyCourse(@RequestParam String courseName){
		...
		return ResponseEntity.status(HttpStatus.ACCEPTED).body(courseService.getAllByCourse(Category.valueOf(courseName.toUpperCase())));
	}
