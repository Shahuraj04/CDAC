...
public class MovieServiecsImpl implements MovieServices {
	...
	public MovieServiecsImpl() {
		 movieMap.put(++counter, new Movie("Inception", Genre.SCI_FI, LocalDate.of(2010, 7, 16), 9, true, 250.0));
	        ...
	        movieMap.put(++counter, new Movie("Avengers: Endgame", Genre.ACTION, LocalDate.of(2019, 4, 26), 9, true, 350.0));
	...
	public void highestRatedMovie() throws MovieException{
		Movie m=movieMap.values().stream()
				.max((m1,m2)->Integer.compare(m1.getRating(),m2.getRating()))
	...
	public String sortByPrice() {
		movieMap.values().stream().sorted((m1,m2)->Double.compare(m1.getTicketPrice(), m2.getTicketPrice()))
